        ...
        <Section>
          <Container>
            ...
            <form action="/api/new-event" method="post">
              ...
              <h4>External link (optional):</h4>
              <span>Title: </span><input className={styles.eventInputBox} name="externalTitle" type="text"></input><br/><br/>
              <span>Full URL</span><input className={styles.eventInputBox} name="externalUrl" type="text"></input><br/><br/>
              <h4>Internal link (optional):</h4>
              <span>Title: </span><input className={styles.eventInputBox} name="internalTitle" type="text"></input><br/><br/>
              <span>Full URL</span><input className={styles.eventInputBox} name="internalUrl" type="text"></input><br/><br/>
