...
describe('Event image path', () => {
  it('returns full image path when image filename is provided', () => {
    expect(eventImagePath('hi.jpg')).to.equal('//res.cloudinary.com/red-badger-assets/image/upload/t_rbthumb/events/hi.jpg');
  });
  it('returns default image path when image filename is not provided', () => {
    expect(eventImagePath()).to.equal('//res.cloudinary.com/red-badger-assets/image/upload/t_rbthumb/events/red-badger-event.jpg');
  });
  it('returns default image path when image filename is null', () => {
    expect(eventImagePath(null)).to.equal('//res.cloudinary.com/red-badger-assets/image/upload/t_rbthumb/events/red-badger-event.jpg');
  });
});
